...
export default async function AdminProducts() {
  ...
  return (
    <section className="flex flex-col justify-center items-center w-screen min-h-screen h-[calc(100vh-30px)] container mx-auto">
      ...
      <ul className="h-[70%] rounded-md overflow-y-scroll grid grid-cols-2 border p-2">
        {allProducts.map((product) => (
          <li className="group p-4 border flex flex-col justify-center items-center gap-2 rounded-md m-2 hover:border-black transition-all ease-in-out duration-200">
